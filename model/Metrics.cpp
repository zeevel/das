...
Metrics::GetReportings () const
{
  return (std::vector<IDescriptor *> &) this->reportings;
}
void
Metrics::AddReporting (Descriptor *reporting)
{
  this->reportings.push_back (reporting);
}
const std::vector<IRange *> &
Metrics::GetRanges () const
{
  return (std::vector<IRange *> &) this->ranges;
}
void
Metrics::AddRange (Range *range)
{
...
void
Metrics::SetMetrics (const std::string &metrics)
{
