...
bool
MultimediaBuffer::addToBuffer (unsigned int segmentNumber,
...
bool
MultimediaBuffer::enoughSpaceInLayeredBuffer (unsigned int segmentNumber,
                                              const dash::mpd::IRepresentation *usedRepresentation)
{
  //determine segment duration
  double duration = (double) usedRepresentation->GetSegmentList ()->GetDuration ();
...
bool
MultimediaBuffer::enoughSpaceInTotalBuffer (unsigned int segmentNumber,
                                            const dash::mpd::IRepresentation *usedRepresentation)
{
  //determine segment duration
  double duration = (double) usedRepresentation->GetSegmentList ()->GetDuration ();
...
bool
MultimediaBuffer::isFull (std::string repId, double additional_seconds)
{
...
bool
MultimediaBuffer::isFull (double additional_seconds)
{
...
double
MultimediaBuffer::getBufferedSeconds ()
{
...
double
MultimediaBuffer::getBufferedSeconds (std::string repId)
{
  double bufferSize = 0.0;
  for (MBuffer::iterator it = buff.begin (); it != buff.end (); ++it)
    {
...
unsigned int
MultimediaBuffer::getHighestBufferedSegmentNr (std::string repId)
{
...
double
MultimediaBuffer::getBufferedPercentage ()
{
  return getBufferedSeconds () / maxBufferedSeconds;
}

double
MultimediaBuffer::getBufferedPercentage (std::string repId)
{
