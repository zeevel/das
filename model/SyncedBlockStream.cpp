...
SyncedBlockStream::SyncedBlockStream () : eos (false)
{
...
void
SyncedBlockStream::PopAndDeleteFront ()
{
...
void
SyncedBlockStream::PushBack (block_t *block)
{
  EnterCriticalSection (&this->monitorMutex);
...
void
SyncedBlockStream::PushFront (block_t *block)
{
  EnterCriticalSection (&this->monitorMutex);
...
const block_t *
SyncedBlockStream::GetBytes (uint32_t len)
{
  EnterCriticalSection (&this->monitorMutex);
...
size_t
SyncedBlockStream::GetBytes (uint8_t *data, size_t len)
{
  EnterCriticalSection (&this->monitorMutex);
...
size_t
SyncedBlockStream::PeekBytes (uint8_t *data, size_t len)
{
  EnterCriticalSection (&this->monitorMutex);
...
size_t
SyncedBlockStream::PeekBytes (uint8_t *data, size_t len, size_t offset)
{
  EnterCriticalSection (&this->monitorMutex);
...
uint64_t
SyncedBlockStream::Length () const
{
  EnterCriticalSection (&this->monitorMutex);
...
uint8_t
SyncedBlockStream::ByteAt (uint64_t position) const
{
  EnterCriticalSection (&this->monitorMutex);
...
void
SyncedBlockStream::EraseFront (uint64_t len)
{
  EnterCriticalSection (&this->monitorMutex);
...
BlockStream *
SyncedBlockStream::GetBlocks (uint64_t len)
{
  EnterCriticalSection (&this->monitorMutex);
...
void
SyncedBlockStream::SetEOS (bool value)
{
  EnterCriticalSection (&this->monitorMutex);
