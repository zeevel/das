...
DOMParser::DOMParser (std::string url) : url (url), reader (NULL), root (NULL)
{
  this->Init ();
}
DOMParser::~DOMParser ()
...
void
DOMParser::AddAttributesToNode (Node *node)
{
...
void
DOMParser::Print (Node *node, int offset)
{
  std::stringstream ss;
