...
std::vector<Node *>
DOMHelper::GetElementByTagName (Node *root, const std::string &name, bool selfContain)
{
...
std::vector<Node *>
DOMHelper::GetChildElementByTagName (Node *root, const std::string &name)
{
  std::vector<Node *> elements;
...
void
DOMHelper::GetElementsByTagName (Node *root, const std::string &name, std::vector<Node *> *elements,
                                 bool selfContain)
{
