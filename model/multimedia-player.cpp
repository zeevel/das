...
void
MultimediaPlayer::SetAvailableRepresentations (
...
bool
MultimediaPlayer::AddToBuffer (unsigned int segmentNr,
...
bool
MultimediaPlayer::EnoughSpaceInBuffer (unsigned int segmentNr,
                                       const dash::mpd::IRepresentation *usedRepresentation,
