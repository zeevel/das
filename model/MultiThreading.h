...
#define SleepConditionVariableCS(cond_p, mutex_p, infinite) \
  WaitCondition (cond_p, mutex_p) // INFINITE should be handled mor properly
...
#define SleepConditionVariableCS(cond_p, mutex_p, infinite) \
  pthread_cond_wait (cond_p, mutex_p) // INFINITE should be handled mor properly
